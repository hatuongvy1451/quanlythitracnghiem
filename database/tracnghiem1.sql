...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2025 at 01:54 PM
...
-- Database: `tracnghiem`
--
CREATE DATABASE IF NOT EXISTS `tracnghiem1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `tracnghiem1`;
...
('TEST004', 'A', 'EX007', '63,62,66,61,64,68,65,67,70,69'),
('TEST004', 'B', 'EX008', '72,71,75,74,78,73,76,80,79,77');
...
INSERT INTO `result` (`rs_num`, `userID`, `exCode`, `rs_answers`, `rs_mark`, `rs_date`) VALUES
...
(7, 8, 'EX007', 'A,A,A,A,A,A,A,A,A,A', 10, '2025-01-24 13:00:00'),
(8, 9, 'EX008', 'A,A,A,A,A,A,A,A,A,A', 10, '2025-01-24 13:30:00');
...
(1, 'TEST001', 'Hệ điều hành Windows', 30, 1, 8, 7, 5, 20, '2025-01-21', 0),
(2, 'TEST002', 'Microsoft Word', 30, 2, 6, 8, 6, 20, '2025-01-22', 0),
(3, 'TEST003', 'Microsoft Excel', 30, 3, 7, 6, 7, 20, '2025-01-23', 0),
(4, 'TEST004', 'Microsoft PowerPoint', 30, 4, 8, 7, 5, 20, '2025-01-24', 0);
...
(2, 'Lê Thị B', 'lethib@gmail.com', '123456', 'Lê Thị B', 0),
(3, 'Trần Quang C', 'tranquangC@gmail.com', '123456', 'Trần Quang C', 0),
(4, 'Phạm Thị D', 'phamthiD@gmail.com', '123456', 'Phạm Thị D', 0),
(5, 'Đinh Văn E', 'dinhvanE@gmail.com', '123456', 'Đinh Văn E', 0),
(6, 'Hà Thị F', 'hatheF@gmail.com', '123456', 'Hà Thị F', 0),
(7, 'Vũ Quang G', 'vuquangG@gmail.com', '123456', 'Vũ Quang G', 0),
(8, 'Bùi Thị H', 'buithiH@gmail.com', '123456', 'Bùi Thị H', 0),
(9, 'Mai Văn I', 'maivanI@gmail.com', '123456', 'Mai Văn I', 0);
...
--
ALTER TABLE `exams`
  ADD PRIMARY KEY (`testCode`,`exOrder`) USING BTREE,
  ADD KEY `exCode_fk` (`exCode`);
...
ALTER TABLE `logs`
  ...
  ADD KEY `logUserID_fk` (`logUserID`);
...
ALTER TABLE `questions`
  ADD PRIMARY KEY (`qID`),
  ADD KEY `qTopicID_fk` (`qTopicID`);

--
-- Indexes for table `result`
--
ALTER TABLE `result`
  ADD PRIMARY KEY (`exCode`,`rs_num`,`userID`) USING BTREE,
...
--
ALTER TABLE `test`
  ADD PRIMARY KEY (`testID`,`tpID`),
  ADD KEY `tpID_fk` (`tpID`),
  ADD KEY `testCode_fk` (`testCode`);
...
--
ALTER TABLE `answers`
  ADD CONSTRAINT `qID_fk` FOREIGN KEY (`qID`) REFERENCES `questions` (`qID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `exams`
--
ALTER TABLE `exams`
  ADD CONSTRAINT `exCode_fk` FOREIGN KEY (`exCode`) REFERENCES `result` (`exCode`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `logs`
--
ALTER TABLE `logs`
  ADD CONSTRAINT `logUserID_fk` FOREIGN KEY (`logUserID`) REFERENCES `users` (`userID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `questions`
--
ALTER TABLE `questions`
  ADD CONSTRAINT `qTopicID_fk` FOREIGN KEY (`qTopicID`) REFERENCES `topics` (`tpID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `test`
  ADD CONSTRAINT `testCode_fk` FOREIGN KEY (`testCode`) REFERENCES `exams` (`testCode`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tpID_fk` FOREIGN KEY (`tpID`) REFERENCES `topics` (`tpID`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
